...
EspStatus.Text = "Edited by picho"
...
st1_2.Text = "Presiona E para aimbot"
...
st1_3.Text = "Presiona T y L para WH"
...
warn("loaded")local plrs = game:GetService("Players")
local TeamBased = true ; local teambasedswitch = "o"
local presskeytoaim = true; local aimkey = "e"
local raycast = false
